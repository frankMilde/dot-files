...
" ---------- F-key mappings  ------------------------------------
"
"   Alt-F10   write buffer and compile
"       F10   compile and link
"  Ctrl-F10   run executable
" Shift-F10   command line arguments
"
 map  <buffer>  <silent>  <A-F10>       :call C_Compile()<CR>:call C_HlMessage()<CR>
imap  <buffer>  <silent>  <A-F10>  <C-C>:call C_Compile()<CR>:call C_HlMessage()<CR>
"
 map  <buffer>  <silent>    <F10>       :call C_Link()<CR>:call C_HlMessage()<CR>
imap  <buffer>  <silent>    <F10>  <C-C>:call C_Link()<CR>:call C_HlMessage()<CR>
"
 map  <buffer>  <silent>  <C-F10>       :call C_Run()<CR>
imap  <buffer>  <silent>  <C-F10>  <C-C>:call C_Run()<CR>
"
 map  <buffer>  <silent>  <S-F10>       :call C_Arguments()<CR>
imap  <buffer>  <silent>  <S-F10>  <C-C>:call C_Arguments()<CR>
"
