...
/* tagging */
static const char *tags[] = { "1[vi] ", "2[evince] ", "3[code] ", "4[plot] ", "5", "6", "7[music] ", "8[email] ", "9[interwebs]" };
...
/* commands */
/* using own dmenu, where certain browsers are removed */
static const char *dmenucmd[] = { "/home/frank/bin/dmenu_run", "-fn", font, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
//static const char *dmenucmd[] = { "/home/frank/bin/dmenu_run", "-fn", font, "-nb", colors[0][ColBG], "-nf", colors[0][ColFG], "-sb", colors[1][ColBG], "-sf", colors[1][ColFG], NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,							XK_x,			spawn,				{.v = xlockcmd } },
};
